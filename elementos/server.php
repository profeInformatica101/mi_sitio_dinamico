...
<head>
    <meta charset="UTF-8">
    <title>Datos del Navegador y del Servidor</title>
    <style>
        table {
...
<body>
    <table class="table-info">
        <tr>
            <th colspan="2" class="title">Datos sobre el Navegador enviados en las Cabeceras HTTP</th>
        </tr>
        <tr>
        ...
        <tr>
            <th colspan="2" class="title">Solicitud HTTP</th>
        </tr>
        <tr>
        ...
        <tr>
            <th colspan="2" class="title">Ubicación del archivo que se está ejecutando</th>
        </tr>
        <tr>
